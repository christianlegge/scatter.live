...
app.controller('simController', ['$scope', '$http', '$interval', '$document', function($scope, $http, $interval, $document) {
	...
	$scope.settingsPresets = {
		'Settings Presets': '',
		'Default / Beginner': 'AJLSXCHYKJ2AEASMGAAAAGBKLTDDAAAAAKAAA4AEFAA',
		'Easy Mode': 'AJUWXCHYKJA96HSAAAAAACBBLTDDAKJ8S8JACAAANKAAA4GFFAA',
		'S4 Tournament': 'AJTWFCBSKJA9EFSDEAAJACBBMTDDAKAAJAEAC2AJSDGBLADLED7JKQUXEAN3BAJAAWKCLAC',
		'Standard Weekly (2020-03-21)': 'AJ2WXCBSKJA8EBSDEAAAACBBLTDDAKAAJAEAC2AJSDGBLAD9SC3JHLUVNFBAMCAASYJKBA',
		'DDR Weekly (2020-10-01)': 'AJ2WXCHYKJA8FASDEAAAACBBLTDDAKAAJAEAC2AJSDGBLAD9SC3JHLUVNFBAMCAASYJKBA',
		'Scrub Tournament': 'AJ2WXCBSKJA8EBSDEAAAACBBLTDDAKJ8S8JACAJAEAC2AJSDGBLADLED7JKYUAJGBAAJMAWAA',
		'Hell Mode (minus Entrance Shuffle)': 'AJKSYCHYKS2AAASM87B8VTUYLTDRAA29BAAASEXSVBB',
		'Bingo': 'AJ2AWCHYKJ2UEASDEAAAAGBKLTDDAKJ8S82TBASAWJG4TU6EMKA2UAAAWDLLAA'
	};
